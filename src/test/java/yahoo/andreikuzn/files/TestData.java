...
public class TestData {
    ...
    public static String FILETOUPLOAD1 = "pic.jpg";
    public static String FILETOUPLOAD2 = "pic1.jpg";
    public static String TXTFILECONTAINSTEXT = "В Java есть 4 вида циклов: while, for, for-each и do-while.";
    public static String XLSFILECONTAINSTEXT = "392699006";
}
